...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 31, 2019 at 10:23 PM
...
(5, 'حمله مردم عراق به کنسولگری‌ها و سفارت خانه آمریکا در عراق', 'thumb/1109588_575.jpg', '<p>شهروندان عراقی در شهر&zwnj;های مختلف در محکومیت بمباران پایگاه الحشد الشعبی عراق توسط آمریکا تظاهرات کردند و با شعار&zwnj;های ضدآمریکایی فریاد می&zwnj;زدند که &laquo;بغداد آزاد است، آزاد است، آمریکا برو بیرون، تمام دخالت&zwnj;های خارجی را در امور کشورمان رد می&zwnj;کنیم.&raquo;</p>\r\n\r\n<p>به گزارش &laquo;تابناک&raquo;؛ پس از اینکه مراسم تشییع پیکر شهدای حشد شعبی ـ که یکشنبه شب در اثر حمله آمریکا به استان الانبار به شهادت رسیدند ـ به حمله به مقر سفارت آمریکا و تحصن تبدیل شد، نخست&zwnj;وزیری عراق از معترضان خواست سفارت را تخلیه کنند. همچنین در پی رویداد&zwnj;های سفارت آمریکا، وزیر کشور و وزیر دفاع در مقر سفارت آمریکا حاضر شدند. این اتفاقات در حالی است که سفیر آمریکا و کارمندان اصلی سفارت، عراق را ترک کرده&zwnj;اند.</p>\r\n\r\n<p>به گزارش شبکه الجزیره، بعد از رسیدن نیرو&zwnj;های آمریکایی معترضان از داخل سفارت آمریکا در بغداد به اطراف سفارت عقب&zwnj;نشینی کردند.</p>\r\n\r\n<p>نیرو&zwnj;های عراقی نیز گفتند، موفق شدند تظاهرکنندگان را از داخل سفارت بیرون کنند.</p>\r\n\r\n<p style=\"text-align:justify\">سخنگوی سازمان مبارزه با تروریسم نیز گفت، هیچ نیرویی به جز نیرو&zwnj;های سازمان در اطراف سفارت آمریکا نیستند، ماموریت ما تنها مبارزه با تروریسم است.</p>\r\n');
...
(3, 'thumb/img_nature_wide.jpg', 'Caption Two'),
(4, 'thumb/img_snow_wide.jpg', 'Caption Three'),
...
(6, 'حاشیه‌های پررنگ‌تر از متن آخرین بودجه قرن / از شایعه استعفای روحانی تا عزم مجلس برای بنزین ۱۵۰۰ توما', 'thumb/special.jpeg', 'درحالیکه کلیات بودجه سال ۹۹ در کمیسیون تلفیق مجلس با رای ناپلئونی به تصویب رسیده، انتقادها از بودجه چنان است که تصویب آن در صحن علنی بهارستان را دچار اما و اگر کرده است.'),
(7, 'توکلی: فقط به چهار خواسته FATF عمل نکردیم / اکثریت نیامدند که آشوب کنند اما دسته‌ای از فضا استفاده ک', 'thumb/special2.jpeg', 'یک عضو مجمع تشخیص مصلحت نظام گفت: از ۴۱ خواسته FATF به ۳۶ تای آن عمل کردیم و فقط به چهارتای آن عمل نکردیم‌'),
(8, 'تعرفه برق از ابتدای سال ۹۹ چقدر افزایش می‌یابد؟', 'thumb/5e09f9813035b_5e09f9813035e.jpg', 'سخنگوی صنعت برق گفت: برای سال آینده از اول فروردین ماه ۹۹ به میزان ۷ درصد تعرفه برق برای همه مشترکان افزوده می‌شود و مشترکان پرمصرف علاوه بر ۷ درصد، ۱۶ درصد دیگر نیز افزایش تعرفه خواهند داشت.'),
(9, 'بایدن: رئیس‌جمهور شوم اوباما را قاضی دادگاه عالی آمریکا می‌کنم', 'thumb/5e0a2f804d41c_2019-12-30_20-40.jpeg', 'جو بایدن، نامزد ریاست‌جمهوری حزب دموکرات آمریکا در پاسخ به یک سؤال در این خصوص که آیا در صورت رسیدن به ریاست جمهوری، باراک اوباما را به عنوان قاضی دادگاه عالی منصوب خواهد کرد پاسخ داد: \"بله اگر که او خودش قبول کند.\"');
