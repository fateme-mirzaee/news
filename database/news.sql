...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2019 at 12:34 AM
...
(6, 'وای اگـر کار من و عشق به یلدا بکشد !', 'thumb/637119386742143857_lg.jpg', 'سفیدی برف را برای روحتون\r\nسرخی انار رابرای قلبتون\r\nشیرینی هندوانه را برای عشقتون\r\nو بلندای یلدا رابرای زندگی قشنگتون آرزومندیم\r\nو از همراهی چندین ساله شما عزیزان کمال تشکر را داریم\r\nامشب یک دقیقه بیشتر کنارتون هستیم :)\r\nیلداتون مبارک ❤');
